...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Hckmskey) DeepCopyInto(out *Hckmskey) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Hckmskey.
func (in *Hckmskey) DeepCopy() *Hckmskey {
	if in == nil {
		return nil
	}
	out := new(Hckmskey)
...
func (in *Keygroup) DeepCopyInto(out *Keygroup) {
	*out = *in
	...
	if in.Hckmskeys != nil {
		in, out := &in.Hckmskeys, &out.Hckmskeys
		*out = make([]Hckmskey, len(*in))
		copy(*out, *in)
	}
